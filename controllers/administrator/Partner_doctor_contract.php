...
class Partner_doctor_contract extends Admin	
{
	...
	* @var $id String
	*/
	public function edit($partner_code, $doctor_code, $partner_contract_no, $policy_no)
	{
	...
	* @var $id String
	*/
	public function edit_save($partner_code, $doctor_code, $partner_contract_no, $policy_no){
	...
	* @var $id String
	*/
	public function view($partner_code, $dr_code, $partner_contract_no, $policy_no)
	{
