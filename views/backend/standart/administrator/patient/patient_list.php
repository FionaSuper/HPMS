               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <div class="widget-user-header ">
                     <div class="row pull-right">
                        ...
                        <?php is_allowed('patient_add', function(){?>
                        <a class="btn btn-flat btn-success btn_add_new" id="btn_add_new" title="add new Patient" href="<?=  site_url('administrator/patient/add'); ?>"><i class="fa fa-plus-square-o" ></i> Add New Patient</a>
                        <?php }) ?>
                     ...
                     <h5 class="widget-user-desc">List All Patient <i class="label bg-yellow"><?= $patient_counts; ?>  items</i></h5>
                  </div>
						...
						<div class="col-md-8">
							 <div class="col-sm-3 padd-left-0 " >
								<select type="text" class="form-control chosen chosen-select" name="f" id="field" >
								   ...
								   <option <?= $this->input->get('f') == 'CARD_TYPE_CODE' ? 'selected' :''; ?> value="CARD_TYPE_CODE">CARD TYPE CODE</option>
                  ...
                  <table class="table table-bordered dataTable">
                     ...
                     <?php foreach($patients as $patient): ?>
                        <tr data-href='<?= site_url('administrator/patient/view/' . $patient->AUTO_NO); ?>'>
                           ...
                           <td class="clickable-row"><?= _ent($patient->PARTNER_CODE); ?></td> 
                           ...
                           <td class="clickable-row"><?= _ent($patient->DOB); ?></td> 
                           <td class="clickable-row"><?= _ent($patient->DEPD_CODE); ?></td> 
                           <td class="clickable-row"><?= _ent($patient->COUNTER); ?></td> 
                           <td class="clickable-row"><?= _ent($patient->PLAN_CODE); ?></td> 
                           <td class="clickable-row"><?= _ent($patient->BENEFIT_NO); ?></td> 
                           ...
                           <td class="clickable-row"><?= _ent($patient->GP_COPAY); ?></td> 
                           <td class="clickable-row"><?= _ent($patient->SP_COPAY); ?></td> 
                           <td class="clickable-row"><?= _ent($patient->PHY_COPAY); ?></td> 
                           <td class="clickable-row"><?= _ent($patient->HERB_COPAY); ?></td> 
                           <td class="clickable-row"><input type="checkbox" class="flat-red" <?= _ent($patient->GP_EXTRA_MED) == 0 ? "" : "checked"; ?>><?= _ent($patient->GP_EXTRA_MED_BENEFIT); ?></td> 
                           <td class="clickable-row"><input type="checkbox" class="flat-red" <?= _ent($patient->SP_EXTRA_MED) == 0 ? "" : "checked"; ?>><?= _ent($patient->SP_EXTRA_MED_BENEFIT); ?></td> 
                           <td class="clickable-row"><input type="checkbox" class="flat-red" <?= _ent($patient->HERB_EXTRA_MED) == 0 ? "" : "checked"; ?>><?= _ent($patient->HERB_EXTRA_MED_BENEFIT); ?></td> 
