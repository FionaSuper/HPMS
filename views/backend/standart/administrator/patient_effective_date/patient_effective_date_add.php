    ...
    $(document).ready(function(){
				...
				$.ajax({
					...
					success: function(data) {
						...
						if (data['patient_no_count']){
							...
							$("#PATIENT_NO")[0].selectedIndex = -1;
							$('#PATIENT_NO').attr("data-placeholder", "Select the Patient No of " + partner_code);
		...
		$('#PATIENT_NO').change(function(){
			...
			if (patient_no == ""){
				...
				$('#PATIENT_NO').attr("data-placeholder", "Select the Patient No of " + partner_code).trigger("chosen:updated");
				$('#PATIENT_NO').prop('disabled', false).trigger("chosen:updated");
				$('#PARTNER_CODE').prop('disabled', false).trigger("chosen:updated");
				...
				$.ajax({
					...
					dataType: "json",
					data: {partner_code: partner_code, patient_no: patient_no, patient_name: patient_name[select_index-1]},
					success: function(data) {
