            ...
            <div class="box-body ">
							...
							<div class="col-sm-4">
								...
								?>
									<div class='col-md-12  padding-left-0'>
										<input checked type="checkbox" class="flat-red" value="<?= $row->AUTO_NO ?>" disabled> <?= $row->CLINIC_PROCEDURE; ?>
									</div> 
								<?php }else{ ?>
			   ...
			   <!------------------------------- Special fee div ------------------------------->
			    <div id="spfeeDiv">
					...
					<div class="view-nav col-sm-12">
					  <?php is_allowed('doctor_consult_hour_add', function($doctor) use ($doctor){?>
					  <a class="btn btn-flat btn-info btn_edit btn_action" id="btn_edit" data-stype='back' title="edit doctor" href="<?= site_url('administrator/doctor/add_consult/'.$doctor->DR_CODE); ?>"><i class="fa fa-edit" ></i> Add Consultation</a><?php }) ?>
					  
					<?php if ($has_doctor_partner){ ?>
						<?php is_allowed('doctor_consult_hour_update', function($doctor) use ($doctor){?>
						<a class="btn btn-flat btn-info btn_edit btn_action" id="btn_edit" data-stype='back' title="edit doctor" href="<?= site_url('administrator/doctor_consult_hour/index?bulk=&q='.$doctor->DR_CODE.'&f=DR_CODE&sbtn=Apply'); ?>"><i class="fa fa-edit" ></i> Edit Consultation</a><?php }) ?>
					<?php } ?>
					...
					<form class="form-horizontal" name="form_doctor" id="form_doctor" >
						...
						<div class="form-group ">
						   ...
						   <div class="col-sm-8">
								<select class="form-control chosen chosen-select-deselect" name="CONTRACT_PARTNER_CODE" id="CONTRACT_PARTNER_CODE">
								   <?php foreach ($doctor_partner as $index=>$partner): ?>
								   <option <?= $index == 0 ? "selected" : ""; ?> value="<?= $partner->PARTNER_CODE; ?>"><?= $partner->PARTNER_CODE; ?></option>
								   <?php endforeach; ?>  
							   </select>
								<small class="info help-block">
								</small>
						...
						<?php if ($has_doctor_contract){ ?>
							<div class="form-group ">
								 <label for="PARTNER_CONTRACT_NAME" class="col-sm-2 control-label">Partner Dr Contract 
							   </label>
							   <div class="col-sm-8">
									<select class="form-control chosen chosen-select-deselect cust-contract-reset-select-1" name="PARTNER_CONTRACT_NAME" id="PARTNER_CONTRACT_NAME">
									   <option value=""></option>
									   <?php foreach ($partner_doctor_contract as $index=>$contract): ?>
									   <option <?= $index == 0 ? "selected" : ""; ?> value="<?= $contract->PARTNER_CONTRACT_NO; ?>"><?= $contract->PARTNER_CONTRACT_NAME." &nbsp; (Policy No: ".$contract->POLICY_NO.") &nbsp; - &nbsp; ".$contract->STATUS; ?></option>
									   <?php endforeach; ?>  
								   </select>
								   <small class="info help-block">
								  </small>
							...
							<input type="hidden" name="POLICY_NO" id="POLICY_NO" value="<?= $contract->POLICY_NO; ?>">
							
							<div class="form-group ">
								<label for="content" class="col-sm-2 control-label">Partner Dr Code </label>

								<div class="col-sm-3">
									<input type="text" class="form-control cust-contract-reset-input-1 cust-contract-reset-input-2" name="PARTNER_DR_CODE" id="PARTNER_DR_CODE" value="<?= $partner->PARTNER_DR_CODE; ?>" disabled> 
									<small class="info help-block">
									</small>
								</div>
								...
								<div class="col-sm-3">
									<input type="text" class="form-control cust-contract-reset-input-1 cust-contract-reset-input-2" name="LOC_CODE" id="LOC_CODE" value="<?= $partner->LOC_CODE; ?>" disabled> 
									<small class="info help-block">
									</small>
								</div>
							</div>
							...
							<div class="form-group ">
								...
								<div class="col-sm-3">
									<input type="text" class="form-control cust-contract-reset-input-1 cust-contract-reset-input-2" name="doctor_contract_START_DATE" id="doctor_contract_START_DATE" value="<?= $contract_details->START_DATE;; ?>" disabled> 
									<small class="info help-block">
									</small>
								</div>
								...
								<div class="col-sm-3">
									<input type="text" class="form-control cust-contract-reset-input-1 cust-contract-reset-input-2" name="doctor_contract_TERM_DATE" id="doctor_contract_TERM_DATE" value="<?= $contract_details->TERM_DATE;; ?>" disabled> 
									<small class="info help-block">
									</small>
								</div>
							</div>			
							...
							<hr>
								...
								<div class="form-group ">
									<label for="CONTRACT_TYPE" class="col-sm-2 control-label">Type 
									</label>
								   <div class="col-sm-3">
										<select class="form-control chosen chosen-select-deselect" name="CONTRACT_TYPE" id="CONTRACT_TYPE">
										   <option value="<?= $doctor_type->TYPE1; ?>"><?= $doctor_type->TYPE1; ?></option>
										   
										   <?php if ($doctor_type->TYPE2 != ""){?>
										   <option value="<?= $doctor_type->TYPE2; ?>"><?= $doctor_type->TYPE2; ?></option>
										   <?php } ?>
										   
										   <?php if ($doctor_type->TYPE3 != ""){?>
										   <option value="<?= $doctor_type->TYPE3; ?>"><?= $doctor_type->TYPE3; ?></option>
										   <?php } ?>
									   </select>
									   <small class="info help-block">
										</small>
								   ...
								   <?php if ($has_special_fee){ ?>
									   ...
									   <div class="col-sm-3">
											<select class="form-control chosen chosen-select-deselect cust-contract-reset-select-1 cust-contract-reset-select-2" name="MED_DAYS" id="MED_DAYS">
											   <?php foreach ($doctor_special_fee as $index=>$sp_fee): ?>
											   <option <?= $index == 0 ? "selected" : ""; ?> value="<?= $sp_fee->MED_DAYS; ?>"><?= $sp_fee->MED_DAYS; ?></option>
											   <?php endforeach; ?>  
											</select>
											<small class="info help-block">
										  </small>
								...
								<div class="form-group ">
								   ...
								   <div class="col-sm-8">
									  <input type="text" class="form-control cust-contract-reset-input-1 cust-contract-reset-input-2" name="SPECIAL_FEE" id="SPECIAL_FEE" value="<?= $doctor_special_fee[0]->SPECIAL_FEE; ?>" readonly>
									  <small class="info help-block">
									  </small>
								   </div>
								</div>
								...
								<div class="form-group ">
								   <label for="SP_REMARK" class="col-sm-2 control-label">Remark 
								   </label>
								   <div class="col-sm-8">
									  <textarea id="SP_REMARK" name="SP_REMARK" rows="5" class="textarea" disabled><?= $doctor_special_fee[0]->REMARK; ?></textarea>
									  <small class="info help-block">
									  </small>
								   </div>
								</div>
								<?php }else{ echo "This doctor has no special fee in this type"; } ?>
								
							<?php }else{ echo "This doctor has no contract with this business partner"; } ?>
   ...
   $(document).ready(function(){
	   ...
	   $("#CENTER_CODE").change(function() {
			...
			$.ajax({
				...
				success: function(data) {
					...
					if (value.SCHEDULE_DAY_E1 != ""){
						...
						console.log(value.SCHEDULE_DAY_E1 + " ," + value.TIMESLOT1_1);
					}
					...
					if (value.SCHEDULE_DAY_E2 != ""){
						...
						console.log(value.SCHEDULE_DAY_E2 + " ," + value.TIMESLOT2_1);
					}
					...
					if (value.SCHEDULE_DAY_E3 != ""){
						...
						console.log(value.SCHEDULE_DAY_E3 + " ," + value.TIMESLOT3_1);
					}
		...
		$("#CONTRACT_PARTNER_CODE").change(function() {
			...
			$("#MED_DAYS").attr("data-placeholder", "　");
			...
			if (partner_code != ""){
				...
				$.ajax({
					...
					dataType: "json",
					data: {dr_code: dr_code, partner_code: partner_code, type: type},
					success: function(data) {

						var value = data['specific_partner'];
						var contract_details = data['contract_details'];
						
						$.each(value, function(index, val) {
							$('#PARTNER_CONTRACT_NAME').append("<option value='" + val.PARTNER_CONTRACT_NO + "'>" + 
							val.PARTNER_CONTRACT_NAME + " &nbsp; (Policy No: " + val.POLICY_NO + ") &nbsp; - &nbsp; " + 
							val.STATUS + "</option>");
						});
						
						$("#PARTNER_DR_CODE").val(value[0].PARTNER_DR_CODE);
						$("#LOC_CODE").val(value[0].LOC_CODE);
						$("#doctor_contract_START_DATE").val(contract_details.START_DATE);
						$("#doctor_contract_TERM_DATE").val(contract_details.TERM_DATE);
						...
						if (data['has_med_days']){
							...
							$("#SPECIAL_FEE").val(data['med_days'][0].SPECIAL_FEE);
							$("#SP_REMARK").text(data['med_days'][0].REMARK);
							
							$("#MED_DAYS")[0].selectedIndex = 0;
							$("#MED_DAYS").prop("disabled", false).trigger('chosen:updated');
							
						}else{
							$("#SPECIAL_FEE").val("No special fee in this type");
						}
