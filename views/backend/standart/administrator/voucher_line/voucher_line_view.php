               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <div class="form-horizontal" name="form_voucher_line" id="form_voucher_line" >
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-sm-8">
                           <?= _ent($voucher_line->PARTNER_CODE); ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group ">
                        <label for="content" class="col-sm-2 control-label">REFERRAL TYPE </label>

                        <div class="col-sm-8">
                           <?= _ent($voucher_line->REFERRAL_TYPE); ?>
                        </div>
                    </div>
