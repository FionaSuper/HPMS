               ...
               <!--     <div class="form-group">
                        ...
                        <div class="col-sm-2">
                          ...
                          <div class="col-sm-2">
                            ...
                            <div  class="col-sm-2">
                                <select id="PARTNER_CODE" class="chosen chosen-select-deselect">
                                 <OPTION VALUE=''> SELECT PARTNER CODE</OPTION>>
                                <?php foreach ($PARTNER_CODE as $row): ?>
                                 <option value="<?= $row->PARTNER_CODE ?>"><?= $row->PARTNER_CODE; ?></option>
                                 <?php endforeach;?>
                             </select>
                            </div>
                        ...
                        <fieldset id="step2">
                            ...
                            <div class="col-sm-2">
                                <input type="text" class="" name="CARD_TYPE" id="CARD_TYPE">
                        ...
                        <div class="form-group">
                            ...
                            <label for="REFERRAL_TYPE" class="col-sm-2 control-label">REFERRAL TYPE</label>
                            <div class="col-sm-2">
                                <input type="text" class="" name="REFERRAL_TYPE" id="REFERRAL_TYPE">
                            </div>    
                        </div>
                        <div class="form-group ">
        ...
        var PARTNER_CODE = $('#PARTNER_CODE').val();
                $.ajax({
                 ...
                 success: function(res){
                    ...
                    var CARD_TYPEs = res.CARD_TYPEs;  
                    var content = '<option value="">SELECT CARD TYPE</option>'
                    for(var i=0; i<CARD_TYPEs.length;i++){
                        content  += '<option value="'+ CARD_TYPEs[i]['CARD_TYPE'] +'">' + CARD_TYPEs[i]['CARD_TYPE']+ '</option>'
                    }
                ...
                $('#partner_dr').on('change',function(){
                  ...
                  var PARTNER_CODE = $('#PARTNER_CODE').val();
                  var CARD_TYPE = $('#partner_policy').val();
                 $.ajax({
                        url:BASE_URL + 'administrator/voucher_line/getDoctorData/',
                        method:'GET',
                        dataType:'JSON',
                        data:{'doctor_code':doctor_code,'partner_code':PARTNER_CODE,'card_type':CARD_TYPE},
                        success:function(res){
            ...
            $('#partner_policy').on('change',function(){
                    ...
                    $.ajax({
                        ...
                        method:'GET',
                        dataType:'JSON',
                        data:{'CARD_TYPE':CARD_TYPE,'partner_code':PARTNER_CODE},
                        success:function(res){
...
$('#patient_CODE').on('change',function(){
         ...
         $.ajax({
                 ...
                 method:'GET',
                 dataType:'JSON',
                 data:{'partner_code': PARTNER_CODE,'patient_code':patient_code},
                 success: function(res){
                    ...
                    var CARD_TYPE = $(patient).prop('CARD_TYPE');
                    ...
                    $('#CARD_TYPE').attr('value',CARD_TYPE);
   ...
   $('#MEMBER_HKID').on('blur',function(){
         ...
         $.ajax({
                 ...
                 method:'GET',
                 dataType:'JSON',
                 data:{'partner_code': PARTNER_CODE,'patient_id':HKID},
                 success: function(res){
