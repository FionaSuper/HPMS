    ...
    <div class="row" >
        <div class="col-md-12">
            <div class="box box-warning">
             ...
             <div id="home">
                        <div id="business_partner" class="col-sm-4">
                                <div class="form-group ">
                            <label for="PARTNER_CODE" class="col-sm-2 control-label">PARTNER CODE 
                            </label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="PARTNER_CODE" id="PARTNER_CODE" placeholder="PARTNER CODE" value="<?= set_value('PARTNER_CODE', $business_partner->PARTNER_CODE); ?>">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="BP_E_NAME" value="<?= set_value('BP_E_NAME', $business_partner->C_NAME); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="input-group date col-sm-8">
                              <input type="text" class="form-control pull-right datepicker" name="JOIN_DATE"  placeholder="JOIN DATE" id="JOIN_DATE" value="<?= set_value('business_partner_JOIN_DATE_name', $business_partner->JOIN_DATE); ?>">
                            </div>
                            <small class="info help-block">
                            </small>
                            </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="STATUS" id="STATUS" placeholder="STATUS" value="<?= set_value('STATUS', $business_partner->STATUS); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="E_ADDR1" id="E_ADDR1" placeholder="E ADDR1" value="<?= set_value('E_ADDR1', $business_partner->E_ADDR1); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="E_ADDR2" id="E_ADDR2" placeholder="E ADDR2" value="<?= set_value('E_ADDR2', $business_partner->E_ADDR2); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="E_ADDR3" id="E_ADDR3" placeholder="E ADDR3" value="<?= set_value('E_ADDR3', $business_partner->E_ADDR3); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="E_ADDR4" id="E_ADDR4" placeholder="E ADDR4" value="<?= set_value('E_ADDR4', $business_partner->E_ADDR4); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="E_ADDR5" id="E_ADDR5" placeholder="E ADDR5" value="<?= set_value('E_ADDR5', $business_partner->E_ADDR5); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="E_DISTRICT" id="E_DISTRICT" placeholder="E DISTRICT" value="<?= set_value('E_DISTRICT', $business_partner->E_DISTRICT); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="C_ADDR1" id="C_ADDR1" placeholder="C ADDR1" value="<?= set_value('C_ADDR1', $business_partner->C_ADDR1); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="C_ADDR2" id="C_ADDR2" placeholder="C ADDR2" value="<?= set_value('C_ADDR2', $business_partner->C_ADDR2); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="C_ADDR3" id="C_ADDR3" placeholder="C ADDR3" value="<?= set_value('C_ADDR3', $business_partner->C_ADDR3); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="C_ADDR4" id="C_ADDR4" placeholder="C ADDR4" value="<?= set_value('C_ADDR4', $business_partner->C_ADDR4); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="C_ADDR5" id="C_ADDR5" placeholder="C ADDR5" value="<?= set_value('C_ADDR5', $business_partner->C_ADDR5); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="C_DISTRICT" id="C_DISTRICT" placeholder="C DISTRICT" value="<?= set_value('C_DISTRICT', $business_partner->C_DISTRICT); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="BILLING_DEPT_NAME" id="BILLING_DEPT_NAME" placeholder="BILLING DEPT NAME" value="<?= set_value('BILLING_DEPT_NAME', $business_partner->BILLING_DEPT_NAME); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="SURGICAL_RATING" id="SURGICAL_RATING" placeholder="SURGICAL RATING" value="<?= set_value('SURGICAL_RATING', $business_partner->SURGICAL_RATING); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="DIAG_CODE_STANDARD" id="DIAG_CODE_STANDARD" placeholder="DIAG CODE STANDARD" value="<?= set_value('DIAG_CODE_STANDARD', $business_partner->DIAG_CODE_STANDARD); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
