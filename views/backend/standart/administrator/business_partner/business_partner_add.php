                      ...
                      <ul class="nav nav-tabs">
                         ...
                         <div id="home">
                              <div class="col-md-12">
                                <div class=" form-group col-sm-6">
                                 <label for="PARTNER_CODE" class="col-sm-4 control-label">Partner Code <i class="required">*</i></label>
                                
                                <div class="col-sm-8">
                                    <input type="text" class="cust-required form-control" name="PARTNER_CODE" id="PARTNER_CODE" value="<?= set_value('PARTNER_CODE'); ?>" required maxlength='80'>   
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="cust-required form-control" name="BP_E_NAME">
                        ...
                        <div class="col-md-12">
                          <div class="form-group col-sm-6">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="BP_C_NAME">
                        ...
                        <div class="col-sm-12">
                             <div class="form-group col-sm-6 ">
                            <label for="BILLING_DEPT_NAME" class="col-sm-4 control-label">ATTN
                            </label>
                            <div class="col-sm-8">
                        ...
                        <tbody id="doctor_tbody">
                           <tr>
                            ...
                            <td> 
                                ...
                                <select type="text" name="DR_CODE[]" id="Doctor_select" class="" style="width: 150px;">
...
<script>
    ...
    $(document).ready(function(){
         ...
         $('#add__doctor_btn').on('click',function(){
                htmlText_Doctor ='<tr> <td class="doctor_check"><input type="checkbox" name="checkbox"></td> <td> <?php if ($doctor_code_total !=0){ ?> <select type="text" name="DR_CODE[]" id="Doctor_select" class="" style="width: 150px;"> <option value="">Select Doctor Code</option> <?php foreach ($doctor_codes as $doctor_code) {?> <option value="<?php echo $doctor_code->DR_CODE;?>"><?php echo $doctor_code->DR_CODE; ?></option> <?php }?> </select> <?php } else{ echo 'no doctor code available';}?> </td> <td><input type="text"  name="PARTNER_DR_CODE[]"></td> <td><input type="text"  name="LOC_CODE[]"></td> <td><input type="text" name="D_TERM_DATE[]" class="datepicker"></td> </tr> ';
        ...
        //      $('#PARTNER_CODE').removeClass('invalidInput')

        //      $('#PARTNER_CODE').addClass('validInput');
        //       valid_code = true;
        //      } else{
        //        valid_code = false;
        ...
        //   }else{
        //       $('#PARTNER_CODE').removeClass('validInput');

        //        $('#PARTNER_CODE').addClass('invalidInput');
        //       // $('#PARTNER_CODE').addClass("InvalidInput");
        //        valid_code = false;
        //       }
        //  });
      ...
      $('.btn_save').on('click', function(){
        ...
        $('.loading').show();
          ...
          $.ajax({
          url: BASE_URL + '/administrator/business_partner/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
