            ...
            <div class="box box-warning">
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <?= form_open(base_url('administrator/partner_contact/edit_save/'.$partner_contact->PARTNER_CODE.'/'.$partner_contact->CONTACT_NO), [
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="PARTNER_CODE" id="PARTNER_CODE" value="<?= set_value('PARTNER_CODE', $partner_contact->PARTNER_CODE); ?>" readonly>
