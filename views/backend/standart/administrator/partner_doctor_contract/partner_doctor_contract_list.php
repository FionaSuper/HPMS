                  ...
                  <table class="table table-bordered table-striped dataTable">
                     ...
                     <?php foreach($partner_doctor_contracts as $partner_doctor_contract): ?>
                        <tr>
                           ...
                           <td><?= _ent($partner_doctor_contract->PARTNER_CODE); ?></td> 
                           ...
                           <td width="200">
                              ...
                              <a href="<?= site_url('administrator/partner_doctor_contract/view/'.$partner_doctor_contract->PARTNER_CODE .'/'.$partner_doctor_contract->DR_CODE.'/'.$partner_doctor_contract->PARTNER_CONTRACT_NO.'/'.$partner_doctor_contract->POLICY_NO); ?>" class="label-default"><i class="fa fa-newspaper-o"></i> View
                              <?php }) ?>
                              <?php is_allowed('partner_doctor_contract_update', function($partner_doctor_contract) use ($partner_doctor_contract){?>
                              <a href="<?= site_url('administrator/partner_doctor_contract/edit/'.$partner_doctor_contract->PARTNER_CODE .'/'.$partner_doctor_contract->DR_CODE.'/'.$partner_doctor_contract->PARTNER_CONTRACT_NO.'/'.$partner_doctor_contract->POLICY_NO); ?>" class="label-default"><i class="fa fa-edit "></i> Update</a>
                              <?php }) ?>
                              <?php is_allowed('partner_doctor_contract_delete', function($partner_doctor_contract) use ($partner_doctor_contract){?>
                              <a href="javascript:void(0);" data-href="<?= site_url('administrator/partner_doctor_contract/delete/'.$partner_doctor_contract->PARTNER_CODE .'/'.$partner_doctor_contract->DR_CODE.'/'.$partner_doctor_contract->PARTNER_CONTRACT_NO.'/'.$partner_doctor_contract->POLICY_NO); ?>" class="label-default remove-data"><i class="fa fa-close"></i> Remove</a>
                               <?php }) ?>
                           </td>
                        </tr>
                      <?php endforeach; ?>
