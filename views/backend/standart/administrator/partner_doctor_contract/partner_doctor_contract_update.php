            ...
            <div class="box box-warning">
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <?= form_open(base_url('administrator/partner_doctor_contract/edit_save/'.$partner_doctor_contract->PARTNER_CODE .'/'.$partner_doctor_contract->DR_CODE.'/'.$partner_doctor_contract->PARTNER_CONTRACT_NO.'/'.$partner_doctor_contract->POLICY_NO), [
						...
						<div class="form-group">
						   ...
						   <div class="col-sm-8 cust-required-select">
							  <input type="text" class="form-control" name="PARTNER_CODE" id="PARTNER_CODE"  value="<?= set_value('PARTNER_CODE', $partner_doctor_contract->PARTNER_CODE); ?>" readonly>
								<small class="info help-block">
								 </small>
						   </div>
						</div>
