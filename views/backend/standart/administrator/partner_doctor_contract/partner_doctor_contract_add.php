					...
					<div class="box box-widget widget-user-2">
						...
						<div class="form-group">
						   ...
						   <div class="col-sm-8 cust-required-select">
							  <select name="PARTNER_CODE" class="form-control chosen chosen-select-deselect changeContractNo1" id="partner_code">
								 <option value=""></option>
						...
						<div class="form-group">
						   ...
						   <div class="col-sm-8 cust-required-select">
							  <select name="DR_CODE" class="form-control chosen chosen-select-deselect changeContractNo2" id="doctor_code">
								 <option value=""></option>
...
<script>
    ...
    $(document).ready(function(){
     ...
     $('.changeContractNo1').on('change',function(){
		   ...
		   $("#partner_code").prop("disabled", true).trigger('chosen:updated');
           ...
           if (partner_code != '') {
				...
				$.ajax({
					...
					method: 'GET',
					dataType: 'JSON',
					data: {'partner_code':partner_code, 'doctor_code':doctor_code},
					success: function(res){
						...
						if (res['has_contract']){
							...
							$('#PARTNER_CONTRACT_NO').attr("data-placeholder", "Select the Contract No of " + partner_code);
	  ...
	  $('.changeContractNo2').on('change',function(){
		  ...
		  $("#PARTNER_CONTRACT_NO")[0].selectedIndex = -1;
		  $("#PARTNER_CONTRACT_NO").trigger("chosen:updated");
	  ...
	  $('#PARTNER_CONTRACT_NO').on('change',function(){
		 ...
		 $("#doctor_code").prop("disabled", true).trigger('chosen:updated');
		 $("#partner_code").prop("disabled", true).trigger('chosen:updated');
		 $("#PARTNER_CONTRACT_NO").prop("disabled", true).trigger('chosen:updated');
		 ...
		 $.ajax({
			...
			method: 'GET',
			dataType: 'JSON',
			data: {'partner_code':partner_code, 'dr_code': dr_code, 'policy_no':s_policy_no, 'contract_no':contract_no},
			success: function(data){
				...
				$("#doctor_code").prop("disabled", false).trigger('chosen:updated');
				$("#partner_code").prop("disabled", false).trigger('chosen:updated');
				$("#PARTNER_CONTRACT_NO").prop("disabled", false).trigger('chosen:updated');
