                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="form-group ">
                           ...
                           <div class="form-group ">
							   ...
							   <div class="col-sm-3">
								   <input type="text" class="form-control" name="CENTER_CODE" id="CENTER_CODE" value="<?= set_value('CENTER_CODE', $doctor_consult_hour->CENTER_CODE); ?>" readonly>
								  <small class="info help-block">
								  </small>
							   </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        .done(function(res) {
          if(res.success) {
            var id = $('#doctor_consult_hour_image_galery').find('li').attr('qq-file-id');
            if (save_type == 'back') {
