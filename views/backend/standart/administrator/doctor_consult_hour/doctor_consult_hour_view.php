               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <div class="form-horizontal" name="form_doctor_consult_hour" id="form_doctor_consult_hour" >
                    ...
                    <div class="view-nav">
                        ...
                        <a class="btn btn-flat btn-info btn_edit btn_action" id="btn_edit" data-stype='back' title="edit doctor_consult_hour" href="<?= site_url('administrator/doctor_consult_hour/edit/'.$doctor_consult_hour->CENTER_CODE); ?>"><i class="fa fa-edit" ></i> Edit Doctor Consult Hour</a>
                        <?php }) ?>
