                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <!-- /.widget-user-image -->
                            <h3 class="widget-user-username"><?= _ent($agreed_fee->PARTNER_CODE); ?></h3>
                        ...
                        <?= form_open(base_url('administrator/agreed_fee/edit_save/'.$this->uri->segment(4)), [
                            ...
                            <div class="col-sm-2">
                                <input type="text" class="form-control" name="PARTNER_CODE" id="PARTNER_CODE" value="<?= set_value('PARTNER_CODE', $agreed_fee->PARTNER_CODE); ?>" readonly>
                            </div>

                            <label for="PARTNER_CODE" class="col-sm-2 control-label">CARD TYPE
                            </label>
                            <div class="col-sm-2">
                                <input type="text" class="form-control" name="CARD_TYPE" id="CARD_TYPE" value="<?= set_value('CARD_TYPE', $agreed_fee->CARD_TYPE); ?>" readonly>
                            </div>
                         ...
                         <label for="CO_PAY" class="col-sm-2 control-label">CO PAY 
                          ...
                          <label for="EXTRA_MED_REF" class="col-sm-2 control-label">EXTRA MED REF </label>
                          
                            <div class="col-sm-3">
                                <?php if ($agreed_fee->EXTRA_MED_REF ==1) {
                                 echo '<input type="checkbox"  class="flat-red toltip" name="EXTRA_MED_REF" checked>';
                               } 
                                else{
                                    echo '<input type="checkbox"  class="flat-red toltip" name="EXTRA_MED_REF" >';
                                } ?> 
                                                ...
                                                <div class="form-group ">
                            <label for="LAB_XRAY_BOL" class="col-sm-2 control-label">LAB XRAY </label>
                            ...
                            <label for="LAB_XRAY_REF" class="col-sm-2 control-label">LAB XRAY REF  </label>
                           
                            <div class="col-sm-3">
                                 <?php if ($agreed_fee->LAB_XRAY_REF ==1) {
                                 echo '<input type="checkbox" name="LAB_XRAY_REF" checked class="flat-red toltip">';
                               } 
                                else{
                                    echo '<input type="checkbox" name="LAB_XRAY_REF" class="flat-red toltip">';
                                } ?>
                        </div>
                                  </div>               
                                                ...
                                                <div class="form-group ">
                                <label for="SURGICAL_BOL" class="col-sm-2 control-label">SURGICAL</label>
                              ...
                              <label for="SURGICAL_REF" class="col-sm-2 control-label">SURGICAL REF</label>
                            
                                <div class="col-sm-3">
                                 <?php if ($agreed_fee->SURGICAL_REF ==1) {
                                 echo '<input type="checkbox" name="SURGICAL_REF" checked class="flat-red toltip">';
                               } 
                                else{
                                    echo '<input type="checkbox" name="SURGICAL_REF" class="flat-red toltip">';
                                } ?>
                            </div>
                        </div>
