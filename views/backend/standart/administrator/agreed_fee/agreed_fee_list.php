             ...
             <!--         <div class="col-sm-2 padd-left-0 " >
                     ...
                     <div class="col-sm-3 padd-left-0 " >
                        <select type="text" class="form-control chosen chosen-select" name="f" id="field" >
                           ...
                           <option <?= $this->input->get('f') == 'CARD_TYPE' ? 'selected' :''; ?> value="CARD_TYPE">POLICY NO</option>
                           <option <?= $this->input->get('f') == 'CONTRACT_NAME' ? 'selected' :''; ?> value="CONTRACT_NAME">CONTRACT NAME</option>  <option <?= $this->input->get('f') == 'TYPE' ? 'selected' :''; ?> value="TYPE">TYPE</option>
                           ...
                           <option <?= $this->input->get('f') == 'EXTRA_MED_REF' ? 'selected' :''; ?> value="EXTRA_MED_REF">EXTRA MED REF</option>
                           <option <?= $this->input->get('f') == 'LAB_XRAY_BOL' ? 'selected' :''; ?> value="LAB_XRAY_BOL">LAB XRAY</option>
                           <option <?= $this->input->get('f') == 'LAB_XRAY_REF' ? 'selected' :''; ?> value="LAB_XRAY_REF">LAB XRAY REF</option>
                           <option <?= $this->input->get('f') == 'SURGICAL_BOL' ? 'selected' :''; ?> value="SURGICAL_BOL">SURGICAL</option>
                           <option <?= $this->input->get('f') == 'SURGICAL_REF' ? 'selected' :''; ?> value="SURGICAL_REF">SURGICAL REF</option>
                          </select>
                     </div>
                  ...
                  <table class="table table-bordered table-striped dataTable">
                     ...
                     <?php foreach($agreed_fees as $agreed_fee): ?>
                        <tr  class="clickable-row"  class="label-default" data-href='<?= site_url('administrator/agreed_fee/view/' . $agreed_fee->AUTO_NO); ?>'>
                           ...
                           <td><?= _ent($agreed_fee->PARTNER_CODE); ?></td> 
                           <td><?= _ent($agreed_fee->CARD_TYPE); ?></td>
                           <td></td>
                           <?php $PARTNER_CODE = $agreed_fee->PARTNER_CODE;
                           ...
                           <td><?= _ent($agreed_fee->EXTRA_MED_REF); ?></td> 
                           <td><?= _ent($agreed_fee->LAB_XRAY_BOL); ?></td> 
                           <td><?= _ent($agreed_fee->LAB_XRAY_REF); ?></td> 
                           <td><?= _ent($agreed_fee->SURGICAL_BOL); ?></td> 
                           <td><?= _ent($agreed_fee->SURGICAL_REF); ?></td> 
                           <td width="200">
