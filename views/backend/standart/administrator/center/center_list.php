            ...
            <div class="box-body ">
               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <div class="widget-user-header ">
                     ...
                     <h5 class="widget-user-desc">List All Center <i class="label bg-yellow"><?= $center_counts; ?>  items</i></h5>
                  </div>
                  ...
                  <table class="table table-bordered dataTable">
                     ...
                     <?php foreach($centers as $center): ?>
                         <tr data-href='<?= site_url('administrator/center/view/' . $center->CENTER_CODE); ?>'>
						   ...
						   <td class="clickable-row"><?= _ent($center->E_NAME); ?><br><br><?= _ent($center->C_NAME); ?></td>
