                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">New Center</h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            'name'    => 'form_center', 
						   ...
						   <div class="form-group ">
							  ...
							  <div class="col-sm-4">
								 <input type="text" class="form-control cust-required" name="CENTER_CODE" id="CENTER_CODE" onkeyup="madeChange()" value="<?= set_value('CENTER_CODE'); ?>">
						   ...
						   <div class="form-group ">
							  ...
							  <div class="col-sm-3">
								 <input type="text" class="form-control cust-required" name="E_ADDR1" id="E_ADDR1" placeholder="Address line 1" value="<?= set_value('E_ADDR1'); ?>">
								<small class="info help-block">
								</small>
							  </div>
							  ...
							  <div class="col-sm-3">
								 <input type="text" class="form-control" name="C_ADDR1" id="C_ADDR1" placeholder="Address line 1" value="<?= set_value('C_ADDR1'); ?>">
								<small class="info help-block">
								</small>
							  </div>
							   ...
							   <div class="col-sm-2">
									<select  class="form-control chosen chosen-select-deselect" data-placeholder="Select an Area" name="AREA" id="AREA">
										<option value=""></option>
						   ...
						   <div class="form-group ">
							  ...
							  <div class="col-sm-3">
								 <input type="text" class="form-control" name="E_ADDR2" id="E_ADDR2" placeholder="Address line 2" value="<?= set_value('E_ADDR2'); ?>">
								<small class="info help-block">
								</small>
							  </div>
							  ...
							  <label class="col-sm-2"></label>
							  <div class="col-sm-3">
								 <input type="text" class="form-control" name="C_ADDR2" id="C_ADDR2" placeholder="Address line 2" value="<?= set_value('C_ADDR2'); ?>">
								<small class="info help-block">
								</small>
							  </div>
								...
								<div class="col-sm-2">
									<select  class="form-control chosen chosen-select-deselect" data-placeholder="Select a District" name="DISTRICT" id="DISTRICT" >
										<option value=""></option>
						   ...
						   <div class="form-group ">
							  <label class="col-sm-2"></label>
							  <div class="col-sm-3">
								 <input type="text" class="form-control" name="E_ADDR3" id="E_ADDR3" placeholder="Address line 3" value="<?= set_value('E_ADDR3'); ?>">
								<small class="info help-block">
								</small>
							  </div>
							  ...
							  <label class="col-sm-2"></label>
							  <div class="col-sm-3">
								 <input type="text" class="form-control" name="C_ADDR3" id="C_ADDR3" placeholder="Address line 3" value="<?= set_value('C_ADDR3'); ?>">
								<small class="info help-block">
								</small>
							  </div>
						   ...
						   <div class="form-group ">
							  <label class="col-sm-2"></label>
							  <div class="col-sm-3">
								 <input type="text" class="form-control" name="E_ADDR4" id="E_ADDR4" placeholder="Address line 4" value="<?= set_value('E_ADDR4'); ?>">
								<small class="info help-block">
								</small>
							  </div>
							  ...
							  <label class="col-sm-2"></label>
							  <div class="col-sm-3">
								 <input type="text" class="form-control" name="C_ADDR4" id="C_ADDR4" placeholder="Address line 4" value="<?= set_value('C_ADDR4'); ?>">
								<small class="info help-block">
								</small>
							  </div>
						   </div>
						   ...
						   <div class="form-group ">
							  <label class="col-sm-2"></label>
							  <div class="col-sm-3">
								 <input type="text" class="form-control" name="E_ADDR5" id="E_ADDR5" placeholder="Address line 5" value="<?= set_value('E_ADDR5'); ?>">
								<small class="info help-block">
								</small>
							  </div>
							  ...
							  <label class="col-sm-2"></label>
							  <div class="col-sm-3">
								 <input type="text" class="form-control" name="C_ADDR5" id="C_ADDR5" placeholder="Address line 5" value="<?= set_value('C_ADDR5'); ?>">
								<small class="info help-block">
								</small>
							  </div>
						   ...
						   <!--
							...
							<div class="form-group">
							   <label class="col-sm-3 control-label">Area & District
								<small class="info help-block">
								</small>
							   </label>
							</div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/center/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
