                        ...
                        <?= form_open(base_url('administrator/center/edit_save/'.$this->uri->segment(4)), [
                         ...
                         <div class="form-group ">
						   ...
						   <div class="form-group ">
							  ...
							  <div class="col-sm-3">
								 <input type="text" class="form-control" name="C_ADDR1" id="C_ADDR1" placeholder="Address line 1" value="<?= set_value('C_ADDR1', $center->C_ADDR1); ?>">
								<small class="info help-block">
								</small>
							  </div>
							  ...
							  <div class="col-sm-2">
									<select  class="form-control chosen chosen-select-deselect" data-placeholder="Select an Area" name="AREA" id="AREA">
										...
										<option <?=  $row->REGION == $center->AREA ? 'selected' : ''; ?> value="<?= $row->REGION ?>"><?= $row->REGION; ?></option>
										<?php endforeach; ?>  
									</select>
									<small class="info help-block">
									</small>
						   ...
						   <div class="form-group ">
							  ...
							  <div class="col-sm-3">
								 <input type="text" class="form-control" name="E_ADDR2" id="E_ADDR2" placeholder="Address line 2" value="<?= set_value('E_ADDR2', $center->E_ADDR2); ?>">
								<small class="info help-block">
								</small>
							  </div>
							  ...
							  <label class="col-sm-2"></label>
							  <div class="col-sm-3">
								 <input type="text" class="form-control" name="C_ADDR2" id="C_ADDR2" placeholder="Address line 2" value="<?= set_value('C_ADDR2', $center->C_ADDR2); ?>">
								<small class="info help-block">
								</small>
							  </div>
							  ...
							  <div class="col-sm-2">
									<select  class="form-control chosen chosen-select-deselect" data-placeholder="Select a District" name="DISTRICT" id="DISTRICT" >
										...
										<option <?=  $row->ENG_DISTRICT == $center->E_DISTRICT ? 'selected' : ''; ?> value="<?= $row->AUTO_NO ?>"><?= $row->ENG_DISTRICT; ?>&nbsp;<?= $row->CHI_DISTRICT; ?></option>
										<?php endforeach; ?>   
									</select>
								</div>
						   </div>
						   ...
						   <div class="form-group ">
							  <label class="col-sm-2"></label>
							  <div class="col-sm-3">
								 <input type="text" class="form-control" name="E_ADDR3" id="E_ADDR3" placeholder="Address line 3" value="<?= set_value('E_ADDR3', $center->E_ADDR3); ?>">
								<small class="info help-block">
								</small>
							  </div>
							  ...
							  <label class="col-sm-2"></label>
							  <div class="col-sm-3">
								 <input type="text" class="form-control" name="C_ADDR3" id="C_ADDR3" placeholder="Address line 3" value="<?= set_value('C_ADDR3', $center->C_ADDR3); ?>">
								<small class="info help-block">
								</small>
							  </div>
						   ...
						   <div class="form-group ">
							  <label class="col-sm-2"></label>
							  <div class="col-sm-3">
								 <input type="text" class="form-control" name="E_ADDR4" id="E_ADDR4" placeholder="Address line 4" value="<?= set_value('E_ADDR4', $center->E_ADDR4); ?>">
								<small class="info help-block">
								</small>
							  </div>
							  ...
							  <label class="col-sm-2"></label>
							  <div class="col-sm-3">
								 <input type="text" class="form-control" name="C_ADDR4" id="C_ADDR4" placeholder="Address line 4" value="<?= set_value('C_ADDR4', $center->C_ADDR4); ?>">
								<small class="info help-block">
								</small>
							  </div>
						   </div>
						   ...
						   <div class="form-group ">
							  <label class="col-sm-2"></label>
							  <div class="col-sm-3">
								 <input type="text" class="form-control" name="E_ADDR5" id="E_ADDR5" placeholder="Address line 5" value="<?= set_value('E_ADDR5', $center->E_ADDR5); ?>">
								<small class="info help-block">
								</small>
							  </div>
							  ...
							  <label class="col-sm-2"></label>
							  <div class="col-sm-3">
								 <input type="text" class="form-control" name="C_ADDR5" id="C_ADDR5" placeholder="Address line 5" value="<?= set_value('C_ADDR5', $center->C_ADDR5); ?>">
								<small class="info help-block">
								</small>
							  </div>
						   ...
						   <div class="form-group ">
							  ...
							  <div class="col-sm-8">
								 <input type="text" class="form-control" name="TEL" id="TEL" value="<?= set_value('TEL', $center->TEL); ?>">
								 <small class="info help-block">
								 </small>
							  </div>						  
						   </div>
