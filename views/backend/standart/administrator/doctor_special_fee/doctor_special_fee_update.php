                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
						...
						<div class="form-group ">
						   ...
						   <div class="col-sm-8 cust-required-select">
								<input type="text" class="form-control" name="CARD_TYPE" id="CARD_TYPE" value="<?= set_value('CARD_TYPE', "(Card Type: ".$partner_contract->CARD_TYPE.") \t ".$partner_contract->CONTRACT_NAME); ?>" readonly>
							  <small class="info help-block">
							  </small>
						   </div>
