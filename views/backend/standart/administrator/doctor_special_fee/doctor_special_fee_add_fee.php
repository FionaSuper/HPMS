                    ...
                    <div class="box box-widget widget-user-2">
						...
						<div class="form-group ">
						   ...
						   <div class="col-sm-8 cust-required-select">
								...
								<select class="form-control chosen chosen-select-deselect cust-partner-change" name="PARTNER_CODE" id="PARTNER_CODE">
						...
						<div class="form-group ">
						   ...
						   <div class="col-sm-8 cust-required-select">
							...
							<?php if ($has_partner_contract) { ?>
								<select class="form-control chosen chosen-select-deselect cust-partner-change" name="CARD_TYPE" id="CARD_TYPE">
									 <?php foreach ($partner_contract as $index=>$row): ?>
									 <option value="<?= $row->CARD_TYPE; ?>"><?= "(Card Type: ".$row->CARD_TYPE.") \t ".$row->CONTRACT_NAME; ?></option>
									 <?php endforeach; ?>  
								</select>
							<?php }else{ ?>
								 <input type="text" class="form-control" value="This partner has no activating contract." readonly>
							<?php } ?>
						...
						<div class="form-group ">
							<label for="PARTNER_CODE" class="col-sm-2 control-label">Partner Dr Code
						   </label>
						   <div class="col-sm-8">
