               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <div class="form-horizontal" name="form_doctor_special_fee" id="form_doctor_special_fee" >					
					...
					<div class="form-group ">
					   ...
					   <div class="col-sm-8 cust-required-select">
							<input type="text" class="form-control" name="PARTNER_CODE" id="PARTNER_CODE" value="<?= set_value('PARTNER_CODE', $doctor_special_fee->PARTNER_CODE); ?>" readonly>
					...
					<div class="form-group" >
						...
						<?php
							$this->db->where("PARTNER_CODE", $doctor_special_fee->PARTNER_CODE);
							$this->db->where("CARD_TYPE", $doctor_special_fee->CARD_TYPE);
							
							$contract_name = $this->db->get("partner_contract")->row();
							
						?>
						<div class="col-sm-3">
							<input type="text" class="form-control" name="CARD_TYPE" id="CARD_TYPE" value="<?= $doctor_special_fee->CARD_TYPE; ?>" readonly>
							<small class="info help-block">
							</small>
						</div>
					
						<label for="CONTRACT_NAME" class="col-sm-2 control-label">Contract Name 
						</label>
						<div class="col-sm-3">
							<input type="text" class="form-control" name="CONTRACT_NAME" id="CONTRACT_NAME" value="<?= $contract_name->CONTRACT_NAME; ?>" readonly>
							<small class="info help-block">
							</small>
						</div>
					</div>
