                  ...
                  <table class="table table-bordered dataTable">
                     <thead>
						...
						<tr>
						   ...
						   <td><input type="text" class="form-control" name="PARTNER_CODE" id="PARTNER_CODE" value="<?= $this->input->get('PARTNER_CODE'); ?>"></td>
						   <td><input type="text" class="form-control" name="CARD_TYPE" id="CARD_TYPE" value="<?= $this->input->get('CARD_TYPE'); ?>"></td>
						   <td><input type="text" class="form-control" name="CONTRACT_NAME" id="CONTRACT_NAME" value="<?= $this->input->get('CONTRACT_NAME'); ?>"></td>
                     ...
                     <?php foreach($doctor_special_fees as $doctor_special_fee): ?>
                        <tr data-href='<?= site_url('administrator/doctor_special_fee/view/' . $doctor_special_fee->AUTO_NO); ?>'>
						   ...
						   <td class="clickable-row"><?= _ent($doctor_special_fee->PARTNER_CODE); ?></td>
						   <td class="clickable-row"><?= _ent($doctor_special_fee->CARD_TYPE); ?></td> 
						   <td class="clickable-row"><?= _ent($doctor_special_fee->CONTRACT_NAME); ?></td>
