                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">New Card</h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            'name'    => 'form_card', 
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="AUTO_NO" id="AUTO_NO" placeholder="AUTO NO" value="<?= set_value('AUTO_NO'); ?>">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="PARTNER_CODE" id="PARTNER_CODE" placeholder="PARTNER CODE" value="<?= set_value('PARTNER_CODE'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="PARTNER_CONTRACT_NO" id="PARTNER_CONTRACT_NO" placeholder="PARTNER CONTRACT NO" value="<?= set_value('PARTNER_CONTRACT_NO'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="CARD_TYPE_CODE" id="CARD_TYPE_CODE" placeholder="CARD TYPE CODE" value="<?= set_value('CARD_TYPE_CODE'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="CARD_TYPE" id="CARD_TYPE" placeholder="CARD TYPE" value="<?= set_value('CARD_TYPE'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
