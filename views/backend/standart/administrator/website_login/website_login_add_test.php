...
<section class="content-header">
    <h1>
        Website Login        <small>New Website Login</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">New Website Login</h5>
                            <hr>
                        </div>
                        <?= form_open('', [
							...
							<div class="form-group ">
								...
								<div class="col-sm-8 cust-required-select">
									<select  class="form-control chosen chosen-select-deselect" name="DR_CODE" id="DR_CODE">
										<option value=""></option>
										<?php foreach (db_get_all_data('doctor') as $row): ?>
                            ...
                            <div class="col-sm-8 cust-required-select">
								<select  class="form-control chosen chosen-select-deselect" name="PARTNER_CODE" id="PARTNER_CODE">
									<option value=""></option>
									<?php foreach (db_get_all_data('business_partner') as $row): ?>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control cust-required" name="WEBSITE_ACCOUNT" id="WEBSITE_ACCOUNT" value="<?= set_value('WEBSITE_ACCOUNT'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control cust-required" name="WEBSITE_PASSWORD" id="WEBSITE_PASSWORD" value="<?= set_value('WEBSITE_PASSWORD'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/website_login/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
