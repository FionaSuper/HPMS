...
*/
	...
	public function get($filters = null, $field = null, $limit = 0, $offset = 0, $select_field = [])
	{
		...
		$center_filter = ["PARTNER_CODE", "PATIENT_NO", "PATIENT_NAME"];
		...
		$selection = "patient.PARTNER_CODE as PARTNER_CODE, patient.PATIENT_NO as PATIENT_NO, patient.PATIENT_NAME as PATIENT_NAME, ".
		...
		$this->db->order_by("patient.PARTNER_CODE", "ASC");
