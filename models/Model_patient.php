...
class Model_patient extends MY_Model {
	...
	private $field_search 	= ['AUTO_NO', 'PARTNER_CODE', 'PATIENT_NO', 'POLICY_NO', 'DEPD_CODE', 'PATIENT_NAME', 'GENDER', 'DOB', 'HKID', 'REMARK', 'STATUS', 'GP_COPAY', 'SP_COPAY', 'PHY_COPAY', 'HERB_COPAY', 'GP_EXTRA_MED', 'SP_EXTRA_MED', 'HERB_EXTRA_MED', 'WAIVER_REFERRAL'];
